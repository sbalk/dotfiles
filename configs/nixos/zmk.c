...
/ {
// "Meh" key to define custom commands in e.g., VSCode
#define MEH_KEY  LA(LC(LEFT_SHIFT))
...
combos {
    ...
    // E + D for Enter
    combo_enter {
        timeout-ms = <50>; // Time frame in which both keys need to be pressed
        key-positions = <25 37>;
        bindings = <&kp ENTER>;
    };
...
/ {
    keymap {
        ...
        layer_Base {
            ...
            &kp GRAVE     &kp Z    &kp X     &kp C      &kp V   &kp B  &td_caps_lshift       &kp LCTRL    &lower  &kp RGUI  &kp RCTRL  &td_caps_rshift   &kp N   &kp M  &kp COMMA   &kp DOT  &kp FSLH  &kp PG_UP
 &magic LAYER_Magic 0  &kp HOME  &kp END  &kp LEFT  &kp RIGHT                &bspc_del  &td_lgui_enter  &kp LALT  &kp RALT    &kp RET        &kp SPACE          &kp UP   &kp DOWN  &kp LBKT  &kp RBKT  &kp PG_DN
            >;
        };
       ...
       &mt PLUS EQUAL       &mt EXCL N1          &mt AT N2  &mt HASH N3  &mt DLLR N4  &mt PRCNT N5                                                                                            &mt CARET N6  &mt AMPS N7   &mt STAR N8    &mt LPAR N9     &mt RPAR N0  &mt UNDER MINUS
               &trans            &trans             &trans       &trans       &trans        &trans                                                                                                  &trans       &trans        &trans         &trans          &trans    &mt PIPE BSLH
               &trans            &trans             &trans       &trans       &trans        &trans                                                                                                  &trans       &trans        &trans         &trans  &mt COLON SEMI      &mt DQT SQT
      &mt TILDE GRAVE            &trans             &trans       &trans       &trans        &trans  &td_caps_lshift_sk          &sk LCTRL    &lower  &sk RGUI  &sk RCTRL  &td_caps_rshift_sk        &trans       &trans  &mt LT COMMA     &mt GT DOT  &mt QMARK FSLH           &trans
 &magic LAYER_Magic 0  &mt MEH_KEY HOME  &mt LA(LCTRL) END       &trans       &trans                         &bspc_del  &td_lgui_enter_sk  &sk LALT  &sk RALT     &trans              &trans                     &trans        &trans  &mt LBRC LBKT   &mt RBRC RBKT           &trans
            >;
        };
 ...
 &magic LAYER_Magic 0      &kp CAPS         &kp INS         &kp F11          &kp F12              &to 1  &trans  &trans  &trans  &trans  &trans                          &kp KP_N0     &kp KP_N0    &kp KP_DOT     &kp KP_ENTER           &trans
            >;
        };
